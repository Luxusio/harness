...
rerun focused tests, recompute depth with the prior live depth as a floor, rerun only fresh discovery selected by the recomputed depth, then one fresh formal reviewer. Inline self-review is no fallback.
