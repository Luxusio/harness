...
### 3. Document findings
Create or update:
- `docs/brownfield/inventory.md` — structural map of the area
- `docs/brownfield/findings.md` — verified facts and observations
- `.claude-harness/state/unknowns.md` — things we don't know yet
...
Add new risk zones to `.claude-harness/manifest.yaml` if significant.
