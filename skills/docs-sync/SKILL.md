...
- Update or create the relevant `docs/domains/` file
- Keep focused on what Claude needs to know for future work

**Constraint or rule changes:**
- Update `docs/constraints/project-constraints.md`
- Only for confirmed rules, not hypotheses

**Operational knowledge:**
- Update `docs/runbooks/development.md` or create specific runbooks
- Focus on debugging insights, setup steps, common pitfalls

**Architecture changes:**
- Update `docs/architecture/` if boundaries or patterns changed
- Mark inferred patterns as hypotheses

### 3. Update the index
- Review `docs/index.md` — add new files, remove stale ones
- Keep the index navigable (grouped by purpose)

### 4. Update recent decisions
- Append to `.claude-harness/state/recent-decisions.md` for any durable change
- Format: `- [YYYY-MM-DD] <type>: <short description>`

### 5. Update unknowns
- Move resolved unknowns out of `.claude-harness/state/unknowns.md`
