...
summary: Claude Code execution harness plugin — orchestrates plan/implement/verify loops
updated: 2026-04-05
...
- Hook script changes must specify which lifecycle event is affected
