...
model: sonnet
maxTurns: 10
tools: Read, Edit, Write, MultiEdit, Glob, Grep, LS, Bash, mcp__plugin_harness_harness__write_doc_sync
---
...
Write it through `mcp__plugin_harness_harness__write_doc_sync`. Keep it short and factual.
Record:
