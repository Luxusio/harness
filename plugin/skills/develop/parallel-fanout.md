...
| 7.7 (dogfooder, post-PASS) | `harness:dogfooder` | per frontmatter | Skipped when no user-facing diff (see SKILL.md Phase 7.7). Batches with Phase 7 final-PASS QA spawn |
