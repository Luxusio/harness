...
Adapted from the gstack design-review reference library. Industry-standard examples (Stripe, Vercel, Elm, Rust, etc.) are unchanged; tooling-specific references are harness-native.
...
- [ ] **Protected artifacts**: Owner role enforced by prewrite gate. PLAN.md = plan-skill. HANDOFF.md / DOC_SYNC.md = developer. SUBAGENT_RECEIPTS.jsonl = runtime hook.
