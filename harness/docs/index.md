...
- `harness/memory-index/active/by-subject/` — active records grouped by subject_key (generated)
- `harness/memory-index/active/by-domain/` — active records grouped by scope domain (generated)
- `harness/memory-index/active/by-path/` — active records grouped by scope path (generated)
- `harness/memory-index/active/by-source-path/` — active records grouped by provenance source file (generated)
- `harness/memory-index/active/by-identifier/` — active records referencing specific ADR/REQ identifiers (generated)
- `harness/memory-index/timeline/` — temporal evolution of records grouped by canonical_subject_key (generated)
