...
model: sonnet
maxTurns: 8
tools: Read, Glob, Grep, LS, Bash, mcp__plugin_harness_harness__write_critic_document
---
...
Write the verdict through `mcp__plugin_harness_harness__write_critic_document`. Keep it factual and easy to repair.
Report:
